          ...
          <ul className="hidden lg:flex gap-2 z-10 cursor-pointer font-semibold text-base ">
            {sectionIds.map((section, index) => (
              <li
                ...
                className="relative group px-4 my-auto flex active:text-[#FF69B4] text-white"
              >
                <Link
                  to="/"
                  className={
                    activeLink === section
                      ? "active text-transparent bg-clip-text bg-gradient-to-r from-[#FF69B4] to-purple-400"
                      : ""
                  }
                >
                  {section}
